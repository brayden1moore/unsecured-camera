...
def proxy(url):
    ...
    try:
        ...
        return Response(req.iter_content(chunk_size=10*1024), content_type=content_type, headers={"Connection": "close"})
...
def index():
    ...
    url = live_urls[feed].replace('COUNTER',random.ranint(0,1000000))
